...
protected :
    ...
    int m_border_color = NOIR; ///SURLIGNE POUR LA FORTE CONNEXITE
    int m_border_color_over = VIOLETSOMBRE;///quand la souris est dessus
    int m_border_color_focus = ORANGESOMBRE; ///en drag and drop

    int m_border = 1; ///bordure des boxcollider des sommets
    int m_margin = 1; //distance du poissoir par rapport au haut de la box edge
    int m_padding = 1; //taille globale de la box edge, multiplicateur de dimensions
